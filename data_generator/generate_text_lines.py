...
def generate_mix_rows_chars_with_text(x, y1, y2, row_length, np_background, char_spacing, use_img=False, text=''):
    row_height = y2 - y1 + 1
    x_start = x
...
def generate_mix_cols_chars_with_text(x1, x2, y, col_length, np_background, char_spacing, use_img=False):
    col_width = x2 - x1 + 1
    y_start = y
