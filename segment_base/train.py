...
def main(data_file, src_type, text_type, segment_task, epochs, init_epochs=0, model_struc="densenet_gru",
         weights_path=""):
    ...
    # 加载模型
    train_model, val_model = work_net(stage="train", segment_task=segment_task, text_type=text_type,
