...
from config import SEGMENT_MIX_LINE_ROOT_DIR
...
def check_tags(tags_file, segment_task, text_type):
    ...
    save_path = os.path.join(SEGMENT_MIX_LINE_ROOT_DIR, "samples")
...
def main():
    ...
    # check_tags(tags_file=SEGMENT_MIX_LINE_TAGS_FILE_V, segment_task="mix_line", text_type="vertical")
